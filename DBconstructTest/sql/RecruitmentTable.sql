...
-- 모집중만 보기
SELECT * FROM DB2025_Recruit WHERE recruitment_status = '모집중';

-- 모집마감만 보기
SELECT * FROM DB2025_Recruit WHERE recruitment_status = '모집마감';

-- 근무완료만 보기
SELECT * FROM DB2025_Recruit WHERE recruitment_status = '근무완료';


SELECT * FROM DB2025_Recruit;
#Drop Table DB2025_Recruit;